...
// ═══════════════════════════════════════════════════════════
// 🎮 TOUCH WORLD SERVER v2.8 - NODE.JS VERSION
// FIXED: Proper imports for Render/Node.js
// ═══════════════════════════════════════════════════════════
...
console.log('🚀 Touch World Server v2.8 Starting...');
...
app.get('/health', (req, res) => {
    res.json({ status: 'ok', players: gameState.players.size, version: '2.8' });
});
...
httpServer.listen(PORT, '0.0.0.0', () => {
    console.log('═══════════════════════════════════════');
    console.log('🎮 TOUCH WORLD SERVER v2.8 - RUNNING');
    console.log(`🚀 Port: ${PORT}`);
    console.log('✅ Node.js + Express + Socket.IO');
    console.log('═══════════════════════════════════════');
});
